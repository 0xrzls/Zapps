...
const CampaignsList = ({ filter }: CampaignsListProps) => {
  ...
  useEffect(() => {
    const fetchCampaigns = async () => {
      ...
      const options = {
        ...
        ascending: false,
        filters: {
          display_target: 'campaigns',
          ...(filter !== "All" ? { status: statusMap[filter] || filter.toLowerCase() } : {})
        }
      };
      
      const { data, error } = await backend.campaigns.getAll(options);
            ...
            <div className="relative overflow-hidden">
                ...
                <div className="p-3 pt-2 pb-3">
                  ...
                  <div className="flex items-start gap-3 mb-2">
                    {}
                    <div className="relative z-10 w-14 h-14 md:w-12 md:h-12 rounded-xl border-4 border-background bg-card overflow-hidden flex-shrink-0 -mt-[60px] md:-mt-[52px]">
                      <img 
                    ...
                    {}
                    <div className="relative z-10 flex-1 min-w-0 -mt-11 md:-mt-9">
